...
=== "SVG (interactive)"
    ...
    <text xml:space="preserve" text-anchor="start" x="2" y="-29.88" font-family="Arial" font-size="12.00">TimeZone</text>
...
| Property | Value |
|----------|-------|
| [skos:historyNote](https://w3id.org/citydata/imported/skos/historyNote) | In the original 2006 version of OWL-Time, the TimeZone class, with several properties corresponding to a specific model of time-zones, was defined in a separate namespace "http://www.w3.org/2006/timezone#". 
...
| [skos:historyNote](https://w3id.org/citydata/imported/skos/historyNote) | En la versión original de OWL-Time de 2006, se definió, en un espacio de nombres diferente "http://www.w3.org/2006/timezone#", la clase 'huso horario', con varias propiedades específicas correspondientes a un modelo específico de huso horario.
...
| [skos:scopeNote](https://w3id.org/citydata/imported/skos/scopeNote) | In this implementation TimeZone has no properties defined. It should be thought of as an 'abstract' superclass of all specific timezone implementations. |
| [skos:scopeNote](https://w3id.org/citydata/imported/skos/scopeNote) | En esta implementación 'huso horario' no tiene definidas propiedades. Se debería pensar como una superclase "abstracta" de todas las implementaciones de huso horario específicas. |
