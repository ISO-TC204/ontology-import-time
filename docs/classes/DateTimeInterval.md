...
=== "SVG (interactive)"
    ...
    <text xml:space="preserve" text-anchor="start" x="9.88" y="-101.88" font-family="Arial" font-size="12.00">ProperInterval</text>
    ...
    <g id="a_node2"><a xlink:href="../DateTimeInterval" xlink:title="&lt;TABLE&gt;">
    <polygon fill="lightgray" stroke="none" points="1,-25.88 1,-42.12 93.75,-42.12 93.75,-25.88 1,-25.88"/>
    <text xml:space="preserve" text-anchor="start" x="2" y="-29.88" font-family="Arial" font-size="12.00">DateTimeInterval</text>
...
| Property | Constraint |
|----------|------------|
| subClassOf | [ProperInterval](ProperInterval.md) |
